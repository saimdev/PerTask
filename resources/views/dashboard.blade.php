            ...
            <div class="container-fluid p-3 d-flex flex-column">
                ...
                <div class="row w-100 d-flex">
                    <div class="col col-4 d-flex flex-column align-items-start px-2 py-3">
                        <a href="/dashboard/{{$teachername}}" class="d-flex flex-row align-items-center justify-content-center menu-items my-4 bg-primary p-3" style="border: none; border-radius:8px;"><img src="{{asset('/imgs/logos/home.svg')}}" alt=""> Dashboard</a>
                    ...
                    <div class="row my-3">
                        <div class="container d-flex justify-content-center">
                            <img src="{{asset('/imgs/users/'.$teachername.".jpg")}}" alt="" style="border-radius: 100px; width: 200px;">
                        </div>
                    </div>
                        <div class="row my-2 d-flex justify-content-center" >
                            <div class="col col-6 main text-white d-flex flex-column align-items-center" >
                                    <h2 class="h2 text-center">Hello, {{$teachername}}</h2>
                            ...
                            <div class="row mt-5">
                                <div class="col col-12">
                                    ...
                                    <form action="relode/{{$teachername}}" method="POST">
                                        @csrf
                                        ...
                                        <table class="table text-white p-3" style=" backdrop-filter: blur(15px); background:rgb(124, 124, 124, 0.2)">
                                          ...
                                          <tbody class="p-3">
                                            ...
                                            <tr class="p-3" >
                                              ...
                                              <td><a href="edit/{{$item->id}}/{{$teachername}}" class="text-decoration-none text-white"><img src="{{asset('/imgs/logos/trash.svg')}}" style="width: 20px;" alt=""></a></td>
                                            </tr>
                                            @endforeach
                                            <button class="btn btn-primary mb-2 mt-0" type="submit">Update</button>
                                          </tbody>
                                        </table>
                                        <a class="btn btn-primary bd-highlight mb-3 bg-primary" href="new/{{$teachername}}" role="button" style="border:none; border-radius:100px;">
                                            +</a>
