...
<html lang="en">
    <head>
        ...
        <title>PerTask - Teacher Signup</title>
              ...
              <form action="signup" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <input
                    ...
                    class="form-control bg-transparent p-2  rounded-2"
                    id="exampleInputPassword1"
                    placeholder="Enter Qualification eg: BS, MS, PhD"
                    style="color: #f9efaa;"
                    required
                  />
                </div>
                ...
                <div class="d-flex justify-content-center mt-3">
                    ...
                    <a href="tlogin" class="text-decoration-none" style="font-size: small;"> Signin here</a>
                </div>
              </form>
            </div>
          </div>
