        ...
        <div class="container-fluid p-3 d-flex flex-column">
            ...
            <div class="row w-100 d-flex">
                <div class="col col-4 d-flex flex-column align-items-start px-2 py-3">
                    ...
                    <a href="/settings/{{$teachername}}" class="d-flex flex-row align-items-center justify-content-center menu-items my-4 p-3 bg-primary" style="border: none; border-radius:8px;"><img src="{{asset('/imgs/logos/settings.svg')}}" alt=""> Settings</a>
                ...
                <div class="col col-8 p-4 my-2" style="background:black; border-radius: 3rem 0 3rem 0;">
                    <div class="row my-2 w-100">
                        ...
                        <form action="update/{{$teachername}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row w-100">
                            <div class="col col-12 d-flex justify-content-center">
                                ...
                                <!-- jjj -->
                                <div>
                                    <div class="d-flex justify-content-center mb-4"><img src="{{asset('/imgs/users/'.$teachername.".jpg")}}" alt="" style="border-radius: 100px; width: 200px;"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="department" placeholder="Enter department" value="{{$item->department}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Qualification</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="qualification" placeholder="qualification" value="{{$item->qualification}}">
                                </div>
                                <div class="form-group">
